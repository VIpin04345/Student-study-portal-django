...
from .forms import NotesForm, HomeworkForm, DateInput, DashboardForm, TodoForm,ConversionForm,ConversionLengthForm,ConversionMassForm,UserRegistrationForm
...
def homework(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            homeworks.save()
            messages.success(request, "homework added from by you !!")
    else:
        form = HomeworkForm()
...
# def fixed_syncPostRequest(url, params={},data={},headers={},proxies=None,verify=True):
